...
local groups = {
    ...
    WinSeparator = { ctermfg = cterm_colors.dark_fg, ctermbg = cterm_colors.dark_bg },
    ...
    TelescopeSelection = { ctermfg = cterm_colors.light_blue, ctermbg = cterm_colors.dark_bg, bold = config.bold },

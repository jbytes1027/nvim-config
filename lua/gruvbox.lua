...
local function get_groups()
    ...
    local groups = {
        ...
        diagnosticvirtualtexterror = { bg = colors.red, fg = colors.bg1, bold = true },
        diagnosticvirtualtextwarn = { bg = colors.yellow, fg = colors.bg1, bold = true },
        diagnosticvirtualtextinfo = { bg = colors.blue, fg = colors.bg1, bold = true },
        diagnosticvirtualtexthint = { bg = colors.aqua, fg = colors.bg1, bold = true },

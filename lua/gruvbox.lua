...
local function get_groups()
    ...
    local groups = {
        ...
        DiffDelete = { bg = colors.dark_red, fg = colors.dark_red },
        DiffAdd = { bg = colors.dark_green },
        DiffChange = { bg = colors.bg0 },
        DiffText = { bg = colors.dark_green },
        ...
        diagnosticvirtualtexterror = { bg = colors.red, fg = colors.bg1 },
        diagnosticvirtualtextwarn = { bg = colors.yellow, fg = colors.bg1 },
        diagnosticvirtualtextinfo = { bg = colors.blue, fg = colors.bg1 },
        diagnosticvirtualtexthint = { bg = colors.aqua, fg = colors.bg1 },
        ...
        GitSignsAddNr = { fg = colors.bg4, bg = colors.dark_green },
        GitSignsChangeNr = { fg = colors.bg4, bg = colors.dark_green },
        GitSignsDeleteNr = { fg = colors.bg4, bg = colors.dark_red },
        ...
        ["@text.title.4.html"] = { link = "Normal" },
        ["@text.title.5.html"] = { link = "Normal" },
        ["@text.title.6.html"] = { link = "Normal" },
        ["@text.title.html"] = { link = "Normal" },
        ["@text.literal.html"] = { link = "Normal" },
        --    ["@text.literal.html"] = { link = "Normal" },
...
Gruvbox.setup = function(config) Gruvbox.config = vim.tbl_deep_extend("force", Gruvbox.config, config or {}) end

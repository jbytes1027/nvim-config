...
M.setup_buffer_keybindings = function()
    ...
    vim.keymap.set("n", "]b", "<cmd>BufferLineCycleNext<cr>", { desc = "Toggle Buffer Pin" })
    vim.keymap.set("n", "[b", "<cmd>BufferLineCyclePrev<cr>", { desc = "Toggle Buffer Pin" })
    vim.keymap.set("n", "]B", "<cmd>BufferLineMoveNext<cr>", { desc = "Toggle Buffer Pin" })
    vim.keymap.set("n", "[B", "<cmd>BufferLineMovePrev<cr>", { desc = "Toggle Buffer Pin" })
    vim.keymap.set("n", "<leader>bj", "<cmd>BufferLinePick<cr>", { desc = "Toggle Buffer Pin" })
    vim.keymap.set("n", "<leader>bJ", "<cmd>BufferLinePickClose<cr>", { desc = "Toggle Buffer Pin" })
    vim.keymap.set("n", "<leader>bo", "<cmd>BufferLineCloseOthers<cr>", { desc = "Toggle Buffer Pin" })
end

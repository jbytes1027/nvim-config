...
M.setup_window_and_buffer_keybindings = function()
    ...
    if vim.fn.has("win32") == 1 then
        ...
        local function cmd_quote(s) return '"' .. s:gsub('"', '\\"') .. '"' end
        ...
        vim.keymap.set("n", "<c-w><c-e>", function()
            vim.fn.jobstart({
                ...
                "/c",
                "start",
                '""', -- empty window title required by `start`
                "wt.exe",
                "-d",
                cmd_quote(dir),
                "nvim",
...
M.setup_buffer_keybindings = function()
    ...
    vim.keymap.set("n", "<leader>-", function() require("bufferline").go_to(11, true) end)
    vim.keymap.set("n", "<leader>=", function() require("bufferline").go_to(12, true) end)

    vim.keymap.set("n", "<M-1>", function() require("bufferline").go_to(1, true) end)
    vim.keymap.set("n", "<M-2>", function() require("bufferline").go_to(2, true) end)
    vim.keymap.set("n", "<M-3>", function() require("bufferline").go_to(3, true) end)
    vim.keymap.set("n", "<M-4>", function() require("bufferline").go_to(4, true) end)
    vim.keymap.set("n", "<M-5>", function() require("bufferline").go_to(5, true) end)
    vim.keymap.set("n", "<M-6>", function() require("bufferline").go_to(6, true) end)
    vim.keymap.set("n", "<M-7>", function() require("bufferline").go_to(7, true) end)
    vim.keymap.set("n", "<M-8>", function() require("bufferline").go_to(8, true) end)
    vim.keymap.set("n", "<M-9>", function() require("bufferline").go_to(9, true) end)
    vim.keymap.set("n", "<M-0>", function() require("bufferline").go_to(10, true) end)
    vim.keymap.set("n", "<M-->", function() require("bufferline").go_to(11, true) end)
    vim.keymap.set("n", "<M-=>", function() require("bufferline").go_to(12, true) end)

    vim.keymap.set("n", "<leader>bp", "<cmd>BufferLineTogglePin<cr>", { desc = "Toggle Buffer Pin" })
    vim.keymap.set("n", "<a-p>", "<cmd>BufferLineTogglePin<cr>", { desc = "Toggle Buffer Pin" })
    vim.keymap.set("n", "]b", "<cmd>BufferLineCycleNext<cr>", { desc = ":BufferLineCycleNext" })
    vim.keymap.set("n", "[b", "<cmd>BufferLineCyclePrev<cr>", { desc = ":BufferLineCyclePrev" })
    vim.keymap.set("n", "]B", "<cmd>BufferLineMoveNext<cr>", { desc = ":BufferLineMoveNext" })
    vim.keymap.set("n", "[B", "<cmd>BufferLineMovePrev<cr>", { desc = ":BufferLineMovePrev" })
    vim.keymap.set("n", "<leader>bj", "<cmd>BufferLinePick<cr>", { desc = ":BufferLinePick" })
    vim.keymap.set("n", "<leader>bJ", "<cmd>BufferLinePickClose<cr>", { desc = ":BufferLinePickClose" })
    vim.keymap.set("n", "<leader>bo", "<cmd>BufferLineCloseOthers<cr>", { desc = ":BufferLineCloseOthers" })
end

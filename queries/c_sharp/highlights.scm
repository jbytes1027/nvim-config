; original at https://github.com/tree-sitter/tree-sitter-c-sharp/blob/master/queries/highlights.scm
...
(namespace_declaration
  name: [(qualified_name) (identifier)] @constructor (#set! "priority" 110))
